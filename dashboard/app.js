/**
 * EcoSmart Dashboard - app.js (Actualizado para 1kg y 50%)
 */
...
const settings = Object.assign({
    apiBase: 'http://172.16.211.113:5000', // Reemplaza con la IP de tu API si es necesario
    alertThresh: 50, // ✅ Cambiado de 80 a 50
    binsData: [],
    eventsData: [],
...
async function fetchBins() {
    try {
        ...
        // ✅ Fallback data ACTUALIZADO a 1kg
        settings.binsData = [
            { id: 1, name: "Metal", grams: 0, percent: 0, capacity_kg: 1.0 }, // ✅ 1.0 en lugar de 5.0
            { id: 2, name: "Orgánico", grams: 0, percent: 0, capacity_kg: 1.0 }, // ✅ 1.0 en lugar de 5.0
            { id: 3, name: "Resto", grams: 0, percent: 0, capacity_kg: 1.0 }, // ✅ 1.0 en lugar de 5.0
        ];
        setOnline(false);
    }
}
...
function renderBins(selector = '#binCards') {
    ...
    bins.forEach(bin => {
        ...
        const capacity = (typeof bin.capacity_kg === 'number' && !isNaN(bin.capacity_kg)) ? bin.capacity_kg : 1.0; // ✅ 1.0 por defecto
